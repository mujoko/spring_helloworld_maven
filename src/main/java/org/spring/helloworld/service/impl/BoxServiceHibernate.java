...
@Repository
@Transactional
public class BoxServiceHibernate extends GenericDaoHibernate<BoxModel, Serializable> implements BoxService {
...
//	private SessionFactory sessionFactory;
    ...
    @Autowired
	public BoxServiceHibernate(SessionFactory _sessionFactory) {
